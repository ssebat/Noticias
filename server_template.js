...
router.post('/Empresas/:pEmpresa_Id&:pEmpresa_Nombre&:pEmpresa_DNI&:pEmpresa_FlagVigencia', function (req, res) {
    res.setHeader('Access-Control-Allow-Origin', '*');
    var pEmpresa_Id = req.params.pEmpresa_Id;
    var pEmpresa_Nombre = (req.params.pEmpresa_Nombre == 'null' ? req.params.pEmpresa_Nombre : "'" + req.params.pEmpresa_Nombre + "'");
    ...
    lsql = 'EXEC pConFa_GuardaEmpresa ' + pEmpresa_Id + ", " + pEmpresa_Nombre + ", " + pEmpresa_DNI + ", " + pEmpresa_FlagVigencia;
    executeQuery(res, lsql);
});
...
router.post('/Regiones/:pRegion_Id&:pPais_Id&:pRegion_Numero&:pRegion_Nombre&:pRegion_FlagVigencia', function (req, res) {
    ...
    lsql = 'EXEC pConFa_GuardaRegion ' + pRegion_Id + ", " + pPais_Id + ", " + pRegion_Nombre + ", " + pRegion_Numero + ", " + pRegion_FlagVigencia;
    executeQuery(res, lsql);
});
